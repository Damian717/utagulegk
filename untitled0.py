class History_in_space:
    def year_2008(self):
        print("\n","Events happened in space 2008","/n")
    ...
    def year_2011(self):
        print("\n","Event occured in the field of space 2011","/n")
class History_in_medical():
    def year_2008(self):
        print("\n","Events happened in medical 2008","/n")
    ...
    def year_2011(self):
        print("\n","Event occured in the field of medical 2011","/n")
        
class History_in_sports():
    def year_2008(self):
        print("\n","Events happened in sports 2008","/n")
        ...
        def year_2011(self):
         print("\n","Event occured in the field of sports 2011","/n")
